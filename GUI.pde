...
class Widget
{
  ...
  color inactiveColor = color(250);
  //color activeColor = color(180, 77, 115);
  //color activeColor = color(58, 150, 205);
  
  //color inactiveColor = color(70);
          color activeColor = color(72, 88, 145);
  //color lineColor = color(220);
  
  //color activeColor = color(177, 164, 204);
  color bgColor = inactiveColor;
  
  //color activeColor = color(180, 77, 115);
  //color activeColor = color(206, 130, 164);
  //color activeColor = color(187, 162, 185);
  
      //color activeColor = color(201, 228, 228);
  color lineColor = color(55, 104, 157);
  color lineColor1 = color(0, 32, 64);
...
class RadioButtons extends Widget
{
  ...
  int get()
  {
    for (int i = 0; i < buttons.length; i++)
    {
      if(buttons[i].get())  //w tych dwoch miejscach mozna zablokowac i samemu ustawic miejsce klikniecia 
      {
        return i;  //
      }
    }
